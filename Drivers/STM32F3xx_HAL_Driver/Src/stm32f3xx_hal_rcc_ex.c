...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk) {
	...
	static const uint16_t adc_pll_prediv_table[16U] = { 1U, 2U, 4U, 6U, 8U, 10U,
			12U, 16U, 32U, 64U, 128U, 256U, 256U, 256U, 256U, 256U };
	...
	case RCC_PERIPHCLK_ADC12: {
		...
		/* PLL clock has been selected */
			...
			if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY)) {
				...
				frequency =
						RCC_GetPLLCLKFreq()
								/ adc_pll_prediv_table[(srcclk
										>> RCC_CFGR2_ADCPRE12_Pos) & 0xF];
			}
		}
		break;
	}
